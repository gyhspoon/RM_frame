...
uint8_t find_enemy=0,aim_cnt=0,aim_mode=0,Tx_state=0;//后续在function种加入aim_mode，供操作手选择是否吊射
int16_t current_yaw=0,current_pitch=0;
int16_t receive_cnt=0,receive_rcd=0;//检测帧数
double bullet_speed=10.0,bullet_speed_adjust=0,yaw_adjust=0,pitch_adjust=0;;//后续在function中加入bullet_speed_adjust，供操作手手动校准
